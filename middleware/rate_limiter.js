...
export const authLimiter = rateLimit({
  ...
  legacyHeaders: false,
  handler: (req, res, next, options) => {
    logger.info(CONSOLE_MESSAGES.AUTH_RATE_LIMITER_TRIGGERED);
    logger.info(CONSOLE_MESSAGES.REQUEST_LABEL, { method: req.method, url: req.originalUrl });
    logger.info(CONSOLE_MESSAGES.NODE_ENV_LABEL, { nodeEnv: env.NODE_ENV });
  ...
  skip: req => {
    ...
    logger.info(CONSOLE_MESSAGES.AUTH_RATE_LIMITER_SKIP_CHECK, {
